...
public class CarrinhoSteps {
	...
	public void oProdutoApresentouQuantidadeEsperada(String nomeProduto, String quantidadeProduto) {
		CarrinhoPage carrinhoPage = new CarrinhoPage();
		Assert.assertTrue("O produto ["+nomeProduto+"] deveria ter a quantidade ["+quantidadeProduto+"]",carrinhoPage.apresentouProdutoEsperadoNoCarrinho(nomeProduto,quantidadeProduto));
	}
}